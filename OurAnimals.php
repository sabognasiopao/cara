	...
	<div class="container">
 	<img src="LOGO.png" width="50" height="50" alt="LOGO" class="logo"/> 
		...
		<ul>
        	...
        	<li><a href="OurAnimals.php">Our Animals</a> </li>
		...
		<img src="H.png" width="1530px" height="250px" style="margin-left: -5px; margin-top: 30px; border-radius: 40px">
...
echo "								<li>Gender: ".$dogs['DOG1']['gender']."</li>\n";
...
echo "						<div>\n";
echo "							<h2 > ".$cats['CAT1']['breed']." </h2>\n";
echo "							<ul   style=\"margin-top: -20px; margin-left: -40px; color: black;font-size: 18px;\" >\n";
echo "								<li>Location: ".$cats['CAT1']['location']." </li>\n";
echo "								<li>Gender: ".$cats['CAT1']['gender']." </li>\n";
echo "								<li>Age: ".$cats['CAT1']['age']." </li>\n";
echo "							\n";
echo "							</ul>\n";
echo "						</div></div></div>\n";
echo "				<div class=\"FifthBox\">\n";
...
echo "						<div>\n";
echo "							<h2 > ".$cats['CAT2']['breed']."  </h2>\n";
echo "							<ul   style=\"margin-top: -20px; margin-left: -40px; color: black;font-size: 18px;\" >\n";
echo "								<li>Location: ".$cats['CAT2']['location']." </li>\n";
echo "								<li>Gender: ".$cats['CAT2']['gender']." </li>\n";
echo "								<li>Age: ".$cats['CAT2']['age']." </li>\n";
echo "							\n";
echo "							</ul>\n";
echo "				</div></div></div>\n";
echo "		\n";
...
echo "						<div>\n";
echo "							<h2 > ".$cats['CAT3']['breed']."  </h2>\n";
echo "							<ul   style=\"margin-top: -20px; margin-left: -40px; color: black;font-size: 18px;\" >\n";
echo "								<li>Location: ".$cats['CAT3']['location']." </li>\n";
echo "								<li>Gender: ".$cats['CAT3']['gender']."</li>\n";
echo "								<li>Age: ".$cats['CAT3']['age']."</li>\n";
echo "							\n";
echo "							</ul>\n";
echo "				</div></div></div>	\n";
echo "	</div>\n";
